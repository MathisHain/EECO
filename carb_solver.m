function [H, pH, pCO2, H2CO2, HCO3, CO3, O, CSH] = carb_solver(T,S,DIC, ALK)
...
Ksp =1; %Needs to be added to the equilibrium constants;
dKsp_dz = 0.01/100; %placeholder for the pressure dependence

H2CO3=DIC/K0*(H^2/(H^2+K1*H+K1*K2));
